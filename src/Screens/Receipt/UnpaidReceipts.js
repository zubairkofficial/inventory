...
export default function UnpaidReceipts() {
    ...
    const getUnpaidReceipts = () => {
        axios
          .get(`${Helpers.baseUrl}receipts/unpaid/${Helpers.authParentId}`, Helpers.headers)
          .then((response) => {
    ...
    const handleDelete = (receiptId) => {
        Helpers.confirmBox(`${Helpers.baseUrl}receipts/delete/${receiptId}`, navigate, getUnpaidReceipts)
    };
    ...
    return (
        <div className="page-content">
            <div className="container-fluid">
                <PageTitle title={"Unpaid Receipts"} 
                    children={<div>
                    ...
                    <div className="col-12">
                        <div className="card">
                            <div className="card-body border-bottom">
                                <CardHeader title={"Unpaid Receipts"} setState={setReceipts} data={data} fields={["customer.name", "vehicle.name", "vehicle.model", "totalPrice", "paid", "remaining", "status"]} />
                                <DataTable
                                columns={[
                                    "Sr. #",
                                    "Customer",
