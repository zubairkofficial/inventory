...
export default function Receipts() {
    ...
    const handleDelete = (receiptId) => {
        Helpers.confirmBox(`${Helpers.baseUrl}receipts/delete/${receiptId}`, navigate, getReceipts)
    };
                    ...
                    <div className="col-12">
                        <div className="card">
                            <div className="card-body border-bottom">
                                <CardHeader title={"All Receipts"} setState={setReceipts} data={data} fields={["customer.name", "vehicle.name", "vehicle.model", "totalPrice", "paid", "remaining", "status"]} />
                                <DataTable
                                columns={[
                                    "Sr. #",
                                    "Customer",
